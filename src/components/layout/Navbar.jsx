    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto bg-slate-card/40 backdrop-blur-xl border border-white/5 rounded-2xl px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {!isAuthenticated ? (
            <Link to="/login" className="bg-champagne/10 text-champagne px-5 py-2 rounded-xl text-sm font-sans hover:bg-champagne/20 transition-colors border border-champagne/20">
              Sign In
            </Link>
          ) : (
