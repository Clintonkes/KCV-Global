      ...
      >
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            <h1 className="font-serif text-4xl text-champagne mb-2">Welcome Back</h1>
            <p className="text-platinum/40 text-sm font-sans tracking-wide">Enter your credentials to access your studio.</p>
          </div>
          ...
          <p className="text-center mt-10 text-platinum/40 text-sm font-sans">
            Don't have an account? <Link to="/register" className="text-champagne hover:text-white transition-colors">Join KCV</Link>
          </p>
        </div>
      </motion.div>
    </div>
